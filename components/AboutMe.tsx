    ...
    <section className="home-section" id="about-me">
      <div className="container center">
        ...
        <div className="text-justify">
          ...
          <p>
            I first learned languages like C, C++ and Java which allowed me to
            create strong programming logic. Then, in 2020, I started studying{' '}
            <b>web development</b> where I was fascinated by the dynamism and
            possibilities that exist, learning HTML/CSS/JavaScript and then
            self-taught I specialized in my{' '}
            <a href="#skills">
              <b>Skills</b>
            </a>
            .
